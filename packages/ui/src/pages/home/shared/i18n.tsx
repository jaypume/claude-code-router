...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  ...
  zh: {
    ...
    text: {
      ...
      "Enable this key": "启用该 Key",
      "Disable this key": "禁用该 Key",
      ...
      "OpenCode Go usage credentials": "OpenCode Go 用量凭证",
      "Workspace ID": "工作区 ID",
      "Auth cookie": "Auth Cookie",
      "Get the workspace ID from the opencode.ai workspace URL and the auth cookie from browser DevTools (Application → Cookies → opencode.ai). The cookie is stored only in your local CCR config.": "从 opencode.ai 工作区 URL 获取工作区 ID，从浏览器开发者工具（Application → Cookies → opencode.ai）获取 auth cookie。Cookie 仅保存在你的本地 CCR 配置中。",
      "Insert OpenCode Go usage connector": "插入 OpenCode Go 用量连接器",
      "Adds a connector that reads the OpenCode Go quota page with a workspace ID and auth cookie.": "添加一个使用工作区 ID 和 auth cookie 读取 OpenCode Go 配额页的连接器。",
